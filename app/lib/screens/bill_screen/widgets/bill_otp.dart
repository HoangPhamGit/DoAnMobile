...
class BillOTP extends StatefulWidget {
  final String? phoneNumber;
  final ValueChanged<String>? onCompleted;
  const BillOTP({super.key, this.phoneNumber, this.onCompleted});

  @override
  State<BillOTP> createState() => _BillOTPState();
}

class _BillOTPState extends State<BillOTP> {
